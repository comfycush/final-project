...
describe('User Google Login [SUCCESS CASE]', () => {
  ...
  test('Should send an object with key: access_token, id, email', (done) => {
    ...
    request(app)
      .post('/googleLogin')
      .send({
        token: 'eyJhbGciOiJSUzI1NiIsImtpZCI6IjNkZjBhODMxZTA5M2ZhZTFlMjRkNzdkNDc4MzQ0MDVmOTVkMTdiNTQiLCJ0eXAiOiJKV1QifQ..ZiyY3RDWqpMZOl1wpArdhvDwBpUHylR8kGRv1EJQshN7Xug_yPuaFMaSr2mTc2Xdy1M4a08O2k3BESFlh910pKNhW6Bj2c-qT1qKfiaeewgdCWgUnkpGdm7Iu-9MH0OhcpoYHe2j6V_RfMVE72M8okRdsYAUSjOefSrEWtrkwh2JGAMfLvMnyePPxs8K1kFpBPCTRhtzOktD0UOP5sVFMtglrJoM79NFRTdimRTLqeqxoIwiNsVA73iCvx-5GuN2qe2a2kiFPF0sEStUCLTgdlCU0FUN28VJ3haIXMbL2wyz8h1kUn-1wxsLAls4XBhxYCPxCQS6_fKLBqj8f3-SHw'
      })
      .end((err, res) => {
        if (err) {
          done(err)
