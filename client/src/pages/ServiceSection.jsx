  ...
  return (
    <section id="service-section">
      ...
      <div className="input">
        ...
        <input onChange={(event) => setHeadline(event.target.value)} type="text" name="service-headline" className="service-headline" />
        <label htmlFor="service-headline" className="service-headline">Color</label>
        <input onChange={(event) => setHeadlineColor(event.target.value)} type="color" name="service-headline" className="service-headline" /><br /><br />
        <label htmlFor="service-card1" className="service-card1">Card 1 Image</label>
        <input onChange={(event) => setCardImage1(event.target.files[0])} type="file" name="service-card1" className="service-card1" />
        <br /><br />
        <label htmlFor="service-card1" className="service-card1">Card 1 Title</label>
        <input onChange={(event) => setCardTitle1(event.target.value)} type="text" name="service-card1" className="service-card1" />
        <label htmlFor="service-card1" className="service-card1">Color</label>
        <input type="color" onChange={(event) => setCardTitleColor1(event.target.value)} name="service-card1" className="service-card1" />
        <br /><br />
        <label htmlFor="service-card1" className="service-card1">Card 1 Text</label>
        <input onChange={(event) => setCardText1(event.target.value)} type="text" name="service-card1" className="service-card1" />
        <label htmlFor="service-card1" className="service-card1">Color</label>
        <input type="color" onChange={(event) => setCardTextColor1(event.target.value)} name="service-card1" className="service-card1" />
        <br /><br />
        <label htmlFor="service-card1" className="service-card1">Card 1 Background Color</label>
        <input type="color" onChange={(event) => setcardBackgroundColor1(event.target.value)} name="service-card1" className="service-card1" />
        <br /><br />
        <label htmlFor="service-card2" className="service-card2">Card 2 Image</label>
        <input onChange={(event) => setCardImage2(event.target.files[0])} type="file" name="service-card2" className="service-card2" />
        <br /><br />
        <label htmlFor="service-card2" className="service-card2">Card 2 Title</label>
        <input onChange={(event) => setCardTitle2(event.target.value)} type="text" name="service-card2" className="service-card2" />
        <label htmlFor="service-card2" className="service-card2">Color</label>
        <input type="color" onChange={(event) => setCardTitleColor2(event.target.value)} name="service-card2" className="service-card2" />
        <br /><br />
        <label htmlFor="service-card2" className="service-card2">Card 2 Text</label>
        <input onChange={(event) => setCardText2(event.target.value)} type="text" name="service-card2" className="service-card2" />
        <label htmlFor="service-card2" className="service-card2">Color</label>
        <input type="color" onChange={(event) => setCardTextColor2(event.target.value)} name="service-card2" className="service-card2" />
        <br /><br />
        <label htmlFor="service-card2" className="service-card2">Card 2 Background Color</label>
        <input type="color" onChange={(event) => setcardBackgroundColor2(event.target.value)} name="service-card2" className="service-card2" />
        <br /><br />            
        <label htmlFor="service-card3" className="service-card3">Card 3 Image</label>
        <input onChange={(event) => setCardImage3(event.target.files[0])} type="file" name="service-card3" className="service-card3" />
        <br /><br />
        <label htmlFor="service-card3" className="service-card3">Card 3 Title</label>
        <input onChange={(event) => setCardTitle3(event.target.value)} type="text" name="service-card3" className="service-card3" />
        <label htmlFor="service-card3" className="service-card3">Color</label>
        <input type="color" onChange={(event) => setCardTitleColor3(event.target.value)} name="service-card3" className="service-card3" />
        <br /><br />
        <label htmlFor="service-card3" className="service-card3">Card 3 Text</label>
        <input onChange={(event) => setCardText3(event.target.value)} type="text" name="service-card3" className="service-card3" />
        <label htmlFor="service-card3" className="service-card3">Color</label>
        <input type="color" onChange={(event) => setCardTextColor3(event.target.value)} name="service-card3" className="service-card3" />
        <br /><br />
        <label htmlFor="service-card3" className="service-card3">Card 3 Background Color</label>
        <input type="color" onChange={(event) => setcardBackgroundColor3(event.target.value)} name="service-card3" className="service-card3" />
        <br /><br />
        <label htmlFor="background-color-service">Background Color</label>
        <input type="color" onChange={(event) => setBackgroundColor(event.target.value)} name="background-color-service" id="background-color-service" /><br /><br />
        ...
        <div className="button-service">
          <button onClick={() => history.push('/about-section')}>prev</button>
