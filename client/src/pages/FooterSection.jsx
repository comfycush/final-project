  ...
  return (
    <section id="footer-section">
      ...
      <div className="input">
        ...
        <input onChange={(event) => setFacebook(event.target.value)} type="text" name="link-facebook" className="link-facebook" /><br /><br />
        <label htmlFor="link-instagram" className="link-instagram">Link Instagram</label>
        <input onChange={(event) => setInstagram(event.target.value)} type="text" name="link-instagram" className="link-instagram" /><br /><br />
        <label htmlFor="link-instagram" className="link-instagram">Link Twitter</label>
        <input onChange={(event) => setTwitter(event.target.value)} type="text" name="link-twitter" className="link-twitter" /><br /><br />
        <label htmlFor="link-linkedin" className="link-linkedin">Link Linkedin</label>
        <input onChange={(event) => setLinkedin(event.target.value)} type="text" name="link-linkedin" className="link-linkedin" /><br /><br />
        <label htmlFor="link-youtube" className="link-youtube">Link Youtube</label>
        <input onChange={(event) => setYoutube(event.target.value)} type="text" name="link-youtube" className="link-youtube" /><br /><br />
        <label htmlFor="company-name-color" className="company-name-color">Company Name Color</label>
        <input onChange={(event) => setCompanyNameColor(event.target.value)} type="color" name="company-name-color" className="company-name-color" /><br /><br />
        <label htmlFor="icon-color">Icon Color</label>
        <input onClick={(event) => setIconColor(event.target.value)} defaultValue="black" type="radio" style={{marginLeft: '1.5rem'}} defaultValue="black" name="black-icon" id="black-icon" />
        <label htmlFor="black-icon">Black</label>
        <input onClick={(event) => setIconColor(event.target.value)} defaultValue="white" type="radio" name="white-icon" defaultValue="white" id="white-icon" />
        ...
        <div className="button-footer">
          <button onClick={() => history.push('/contact-section')}>prev</button>
